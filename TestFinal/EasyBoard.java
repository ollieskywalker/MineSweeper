...
public class EasyBoard extends JPanel implements Sky {
	private final static int X = 9;
	private final static int Y = 9;
	private final int NUMBOMBS = 10;
	public Tile[][] grids = new Tile[X][Y];
					...
					public void actionPerformed(ActionEvent e) {
						if (firstClick) {
							...
							while (h > 0) {
								...
								int nx = generator.nextInt(8) + 1;
								Random generator2 = new Random();
								int ny = generator.nextInt(8) + 1;
